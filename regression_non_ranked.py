...
def probit_parameterized(x, y, arrival_choice, cut_choice, cap_mode_choice=2):
    """
...
def regression_all_cuts_all_arrivals(zone_choice, cap_mode_choice):
    ...
    for arrival in tqdm(arrivals):
        for cut in cuts:
            features, targets = get_regression_features(zone_choice, cap_mode_choice=cap_mode_choice, arrival_choice=arrival, cut_choice=cut)
